...
<div class="container my-5">
    <div class="row p-4 pb-0 pe-lg-0 pt-lg-5 align-items-center rounded-3 border shadow-lg">
      <div class="col-lg-7 p-3 p-lg-5 pt-lg-3">
        <h1 class="display-3 fw-light lh-1 text-body-emphasis bg-warning border-primary " style="margin-top:75px;border-radius:10px;background-image:linear-gradient(lightyellow,white);filter:drop-shadow(5px 3px 1px royalblue">
 <a style="filter:drop-shadow(3px 2px 1px white);">DESIGN + BUILD</a>
 <br>
</h1>
<p>
 &#11088;	
